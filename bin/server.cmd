...
java -cp %CLASSPATH% -Xms1024m -Xmx1024m -Xloggc:server-gc.log -XX:+UseConcMarkSweepGC -XX:+PrintGCDetails -XX:+PrintGCTimeStamps org.marketdata.server.MarketDataServer
